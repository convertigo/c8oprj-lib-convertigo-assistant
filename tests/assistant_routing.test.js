...
assert.match(pageSource, /lib_ConvertigoAgentBridge", version: "0\.4\.14", tag: "v0\.4\.14"/);
assert.match(pageSource, /lib_ConvertigoAssistant", version: "1\.4\.32", tag: "v1\.4\.32"/);
