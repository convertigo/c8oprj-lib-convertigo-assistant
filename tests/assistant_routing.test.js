...
assert.match(pageSource, /lib_ConvertigoAgentBridge", version: "0\.4\.15", tag: "v0\.4\.15"/);
assert.match(pageSource, /lib_ConvertigoAssistant", version: "1\.4\.33", tag: "v1\.4\.33"/);
