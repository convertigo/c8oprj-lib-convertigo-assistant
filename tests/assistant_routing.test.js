...
assert.match(pageSource, /lib_ConvertigoAgentBridge", version: "0\.4\.16", tag: "v0\.4\.16"/);
assert.match(pageSource, /lib_ConvertigoAssistant", version: "1\.4\.34", tag: "v1\.4\.34"/);
